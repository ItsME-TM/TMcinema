...
function NavBar() {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      ...
      gap-8 md:px-8 py-3 max-md:h-screen md:rounded-full backdrop-blur bg-black/70 md:bg-white/10
      ...
      <Menu className="md:hidden max-md:ml-4 w-8 h-8 cursor-pointer" onClick={() => setIsOpen(!isOpen)}/>
    </div>
  );
}
